 ...
 * {@link PhotoInfoFragment.OnFragmentInteractionListener} interface
...
public class PhotoInfoFragment extends Fragment {
    ...
    private static final String ARG_FILE_LOCATION = "fileloc";
     ...
     *
     * @param fileLocation File Location for image.
     * @return A new instance of fragment PhotoInfoFragment.
     */
    public static PhotoInfoFragment newInstance(String fileLocation) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            fileloc = getArguments().getString(ARG_FILE_LOCATION);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        File imageFile = new File(this.fileloc);
        if(imageFile.exists()){
            ImageView image = rootView.findViewById(R.id.photo_image);
